...
public class StringOutputConstants {
    ...
    public static final String serieError = "Invalid data: serie";
    public static final String repError = "Invalid data: ripetizioni";
    public static final String nameError = "Invalid data: name";
    public static final String successAddingExe = "Esercizio aggiunto alla scheda";
